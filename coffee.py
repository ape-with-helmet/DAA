#owner of a coffee shop wishes to mix a 10 pound bag of coffeee using various types of coffee beans in a such a way to produce the coffee blend at the maximum cost. the weights iof the objects in the problem correspond to quality in pounds available of each type of coffee bean. the value of each coffee beans is the total cost of that quality in rupees. Apply the knap sack algorithm to maximize profit.
